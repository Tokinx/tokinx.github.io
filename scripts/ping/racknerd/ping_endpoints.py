...
# -*- coding: utf-8 -*-
"""
批量 ping RackNerd 官网列出的各机房测试 IP（来自选配页面），次数可配置（见文件顶部常量），输出 CSV，并按平均延迟排序输出 fast.txt。
...
ENDPOINTS = [
    # 北美地区（美国）
    ("北美地区", "美国东部", "纽约 (New York)", "192.3.81.8"),
    ("北美地区", "美国中部", "芝加哥 (Chicago, IL)", "198.23.228.15"),
    ("北美地区", "美国南部", "达拉斯 (Dallas, TX)", "198.23.249.100"),
    ("北美地区", "美国西北", "西雅图 (Seattle)", "192.3.253.2"),
    ("北美地区", "美国西海岸", "圣何塞 (San Jose, CA)", "192.210.207.88"),
    ("北美地区", "美国西海岸", "洛杉矶 (Los Angeles DC03, CA)", "107.174.51.158"),
    ("北美地区", "美国西海岸", "洛杉矶 (Los Angeles DC02, CA)", "204.13.154.3"),
    ("北美地区", "美国东部", "阿什本 (Ashburn)", "107.173.166.10"),
    # 北美地区（加拿大）
    ("北美地区", "加拿大东部", "多伦多 (Toronto, Canada)", "167.160.186.8"),
    # 欧洲地区
    ("欧洲地区", "法国东部", "斯特拉斯堡 (Strasbourg)", "45.95.173.2"),
]
