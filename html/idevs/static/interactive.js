...
//            $(canvas).attr('id', 'blur').appendTo('body').wrap("<div class='bg-blur'></div>");
//            var width = $(canvas).width();
//            var height = $(canvas).height();
//            stackBlurCanvasRGBA('blur', 0, 0, width, height, 50);
//        }
//    });
//}
...
$(window).scroll(function () {
    ...
    //$("#blur").attr("style", "transform:translateY(" + -$(this).scrollTop() + "px);")
});
...
function menu_click() {
    $(".menu_click").click(function () {
        $('.menu_click').prop('class', 'menu_close');
        $(".menu_close").click(function () {
            $('.menu_close').prop('class', 'menu_click');
            menu_click();
        });
    });
    return;
